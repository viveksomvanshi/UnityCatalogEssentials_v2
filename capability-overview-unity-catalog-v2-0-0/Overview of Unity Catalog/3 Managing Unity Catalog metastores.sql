...
-- MAGIC * Creating and removing databases, tables and views if other users are not permitted to do so under your data governance policies
-- MAGIC * Integrating external external storage into the metastore
