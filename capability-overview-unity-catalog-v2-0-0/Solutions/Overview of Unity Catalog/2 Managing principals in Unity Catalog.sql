...
-- MAGIC ## Prerequisites
-- MAGIC
-- MAGIC If you would like to follow along with this demo, you will need account adminstrator capabilities over your Databricks account, as creating identities is done in the account admininistrator console.
...
-- MAGIC * Simplifies synchornization. Though Databricks maintains its own identities for its users, the identity provider integration can manage automatically manage users on the admin's behalf
